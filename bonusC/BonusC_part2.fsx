(*
   ...
   Bonus coursework C part 2: Life expectancy  
   ...
   Answer the questions below by writing code. This file is an F#
   script file, it should be possible to load the whole file at
   once. If you can't then you have introduced a syntax error
   somewhere.

   This coursework is optional but you can get extra bonus marks (up to 5 in total for both parts).
   Please submit it as bonusC/bonusC_part2.fsx in the Git system at git.ttu.ee.

   The deadline for completing the above procedure is Tuesday 30, 2014.
